...
class EC2State(MachineState, nixops.resources.ec2_common.EC2CommonState):
    ...
    def create(self, defn, check, allow_reboot, allow_recreate):
        ...
        # Get the ECDSA public key generated by the instance. Then
        # delete the DSA private key generated by us and restart sshd.
        # FIXME: not quite atomic.
        if self.public_host_key.startswith("ssh-dss"):
